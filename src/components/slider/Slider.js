...
function loadTouchEvent() {
  ...
  let touchEndFunction = (e) => {
    ...
    if (direction === 'left') {
      // if(currentComponent.offsetLeft>-30){
    ...
    // 取消过渡效果
    currentComponent.style.transition = '0.1s all ease-in';
  ...
  render() {
    ...
    return (
      <div className="slider-wrap">
        {this.props.children}
        <a onClick={this.handleSliderButtonClick} className="slider-button">退出</a>
      </div>
    );
  }
}
